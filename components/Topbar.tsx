  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-mist-200 bg-white/85 px-4 backdrop-blur sm:px-6">
      ...
      <div className="ml-auto flex items-center gap-3">
        <span className="hidden items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700 sm:flex">
          <CheckCircle2 className="size-3.5" />
          Real Data · Manual Entry
        </span>
